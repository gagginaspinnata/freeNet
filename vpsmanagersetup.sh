...
echo "● Install and configure squid proxy on ports 80, 3128, 8080 e 8799" ; echo "  to allow SSH connections to this serverr"
...
if [ -z "$ipdovps" ]
then
	tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "" ; echo " You did not enter the IP of this server. Try again. " ; echo "" ; echo "" ; tput sgr0
	exit 1
fi
...
echo ""
tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Wait for automatic setup" ; echo "" ; tput sgr0
sleep 3
apt-get update -y
apt-get upgrade -y
...
echo ""
tput setaf 7 ; tput setab 4 ; tput bold ; echo "Squid Proxy Installed and running on ports: 80, 3128, 8080 e 8799. First try 8080 on your client." ; tput sgr0
